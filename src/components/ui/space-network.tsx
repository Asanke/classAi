...
export function SpaceNetwork() {
    ...
    // Simple check for dark mode, defaulting to true if likely dark or system default is dark
    ...
    return (
        <canvas
            ...
            className={`fixed inset-0 w-full h-full pointer-events-none z-[-2] ${isDark ? 'mix-blend-screen opacity-70' : 'mix-blend-multiply opacity-30'}`}
        />
    );
}
