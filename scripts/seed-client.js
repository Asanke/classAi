...
async function seed() {
    ...
    try {
        // 1. Login as Admin
        // Assuming admin@gmail.com exists with 123456 (Standard Demo Creds)
        ...
        // 2. Mock Data
        const instituteId = uid; // Using Admin UID as Institute ID for simplicity in this model
        ...
        for (let i = 0; i < students.length; i++) {
            ...
            // Add Grade (for Z-Score)
            const score = i === 0 ? 92 : i === 1 ? 75 : 45; // High, Mid, Low
            ...
            console.log(`   - Seeded Student: ${s.name} (Score: ${score})`);
        }
